...
export const translations = {
    'uk': {
        ...
        'update_target_app': 'Застосунок (0x79B, FLASH0)',
        'update_target_boot': 'Бутлоадер (0x7E4, FLASH1)',
        'update_crc': 'CRC32 плейнтексту',
        'update_crc_hint': 'Потрібен вихід can_flash.py --no-send --out (уже зашифрований образ). CRC32 візьми з рядка «CRC32 = 0x…» у логу того ж запуску. Контейнер LEAFOTA1 підставляє CRC сам.',
        ...
        'update_warn_app': 'Лише в P/N і без руху. Бутлоадер лишається цілим — невдалу заливку можна повторити. Через ELM327 це 10–30 хв.',
    ...
    'en': {
        ...
        'update_target_app': 'Application (0x79B, FLASH0)',
        'update_target_boot': 'Bootloader (0x7E4, FLASH1)',
        'update_crc': 'Plaintext CRC32',
        'update_crc_hint': 'Use the output of can_flash.py --no-send --out (already encrypted). Take CRC32 from the "CRC32 = 0x..." line of that same run. A LEAFOTA1 container fills it in automatically.',
        ...
        'update_warn_app': 'Park/Neutral and stationary only. The bootloader stays intact, so a failed flash can be retried. Expect 10-30 min over ELM327.',
