...
export const translations = {
    'uk': {
        ...
        'ac_pdm_section': 'Leaf PDM',
        'ac_pcs_section': 'Tesla M3 PCS',
        'ac_settings_section': 'Налаштування',
        ...
        'ac_charge_current_write': 'Макс. струм AC зарядки (спільний PDM/PCS)',
        // Tesla M3 PCS telemetry
        'pcs_state': 'Стан PCS',
        'pcs_chg_stat': 'Стан чарджера',
        'pcs_hw_lim': 'Апаратний ліміт PCS',
        'pcs_ac_voltage': 'Напруга AC',
        'pcs_ac_current': 'Струм AC',
        'pcs_ac_power': 'Потужність AC',
        'pcs_charge_setpoint': 'Задана потужність зарядки',
        'pcs_hv_voltage': 'Напруга HV',
        'pcs_dcdc_lv': 'Напруга LV (DCDC)',
        'pcs_dcdc_current': 'Струм DCDC',
        'pcs_temp_dcdc': 'Температура DCDC',
        'pcs_temp_ambient': 'Температура корпусу',
        // Tesla M3 PCS identity (PCS_info 0x3C4)
        'pcs_details_btn': 'Деталі PCS',
        'pcs_details_title': 'Ідентифікація PCS',
        'pcs_part_number': 'Part number',
        'pcs_serial_number': 'Серійний номер',
        'pcs_hardware_id': 'Hardware ID',
        'pcs_component_id': 'Component ID',
        'pcs_app_crc': 'CRC32 програми',
    ...
    'en': {
        ...
        'ac_charge_current_write': 'Max AC charge current (shared PDM/PCS)',
        // Tesla M3 PCS telemetry
        'pcs_state': 'PCS state',
        'pcs_chg_stat': 'Charger state',
        'pcs_hw_lim': 'PCS HW limit',
        'pcs_ac_voltage': 'AC voltage',
        'pcs_ac_current': 'AC current',
        'pcs_ac_power': 'AC power',
        'pcs_charge_setpoint': 'Charge power setpoint',
        'pcs_hv_voltage': 'HV voltage',
        'pcs_dcdc_lv': 'DCDC LV voltage',
        'pcs_dcdc_current': 'DCDC current',
        'pcs_temp_dcdc': 'DCDC temperature',
        'pcs_temp_ambient': 'Ambient temperature',
        // Tesla M3 PCS identity (PCS_info 0x3C4)
        'pcs_details_btn': 'PCS details',
        'pcs_details_title': 'PCS Identity',
        'pcs_part_number': 'Part number',
        'pcs_serial_number': 'Serial number',
        'pcs_hardware_id': 'Hardware ID',
        'pcs_component_id': 'Component ID',
        'pcs_app_crc': 'Application CRC32',
